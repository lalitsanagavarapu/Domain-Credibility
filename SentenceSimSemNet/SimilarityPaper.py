...
#Parameters set According to the paper (Link in readme)
#Produces best results currently.
...
if __name__ == '__main__':
    ...
    sentence_pairs = [
        ...
        ["RAM keeps things being worked with","The CPU uses RAM as a short-term memory store",0.552]
