...
"virtual local area network","virtual LAN","VLAN","Wireless","Internet","Switch","Router","MUX","multiplex","InformationSecurity","CyberSecurity"]
Application = ["Operating System","Data","Database","File","Physical","Shred","Soft","Stationery","Flight","Transfer","Web","Logs"
"Middle Tier","Logs","InformationSecurity","CyberSecurity"]
...
<<<<<<< HEAD
                    "Incident","Threat","Vulnerability","Attack","Severity","Risk","Impact","Probability","Root cause analysis","InformationSecurity","CyberSecurity"]
=======
                    "Incident","Threat","Vulnerability","Attack","Severity","Risk","Impact","Probability","Root cause analysis"]
>>>>>>> 35217832884a375b14bce0500decf1111d18628f
...
"BCP","Business Continuity Plan ","DR","Disaster Recovery","Backup","Data",
            "Application","Site","Load Balancing","Redundant","People","Call tree","InformationSecurity","CyberSecurity"]
Endpoint=["Computer","Laptop","Thin Client","Mobile Device","Removable Media","Pen drive","CD","DVD","InformationSecurity","CyberSecurity"]
Malware=["Anti-virus","Signature","Phishing","Smishing","Vishing","CSRF","Cross-site request forgery","InformationSecurity","CyberSecurity"]
Cloud=["IaaS","PaaS","SaaS","Software as a Service ","Platform as a Service","Infrastructure as a Service ","InformationSecurity","CyberSecurity"]
Hardware=["Server","Chassis","Blade","Controller","Rack mounted","Tower","Storage","SAN","storage area network","Controller","NAS",
"Network-attached storage","Controller","Disks","SSD","Solid State Drive","Magnetic","Tape","InformationSecurity","CyberSecurity"]
...
,"Password","one-time password ","OTP","Biometric","Log","Retina","Fire Extinguisher","Gas","Liquid","Solid","Emergency",
          ...
          "Smoke","Intrusion","Floor","Raised","Ceiling","False","Rack","InformationSecurity","CyberSecurity"]


#create a series for each list
ret="No useful content"
...
#min characters (parsed content)
minn=100
#print(Network_s.str.lower())
#create a parentlist 
...
def parser(url):
	...
	for t in req_text:
		if t.parent.name not in blacklist or t.parent.name in whitelist:
			output+='{} '.format(t)
	print("Length for",url,"is",len(output))
	#if len(output)<minn:
		#return ret 
	#else:
	return output
...
<<<<<<< HEAD
							#list100=w2v_model_100.wmdistance(sublist,clean)
							#word100=w2v_model_100.wmdistance(word,clean)
							list300=w2v_model_300.wmdistance(lists,clean)
=======
...
>>>>>>> 35217832884a375b14bce0500decf1111d18628f
							...
							print('\n','list300 simcore of ',currlist,'with url=',char,'is',list300,'\n')
...
_600urls=final_df.to_csv("/home/abhishek/Avi/SimScore/CSV_new/_600urls.csv", header=True)
