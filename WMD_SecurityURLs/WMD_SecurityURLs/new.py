...
ss_keyword=pd.DataFrame({'Duration':time_list,'word100':ss100_word,'list100':ss100_list,'word300':ss300_word,'list300':ss300_list,'keyword':keyword_append,'List':listname_append})
...
#infinite WMD  , replace by -1 
final_df['WMD_word100'] = final_df['WMD_word100'].replace(np.inf, -1)
final_df['WMD_list100'] = final_df['WMD_list100'].replace(np.inf, -1)
final_df['WMD_word300'] = final_df['WMD_word300'].replace(np.inf, -1)
final_df['WMD_list300'] = final_df['WMD_list100'].replace(np.inf, -1)
