...
def start():
    ...
    global rel
    rel = searchgraph.similarityllist_rv(keyword)
    print ("rel ",rel)
    ...
    print ("Final similairty score ",final_score)
    print ("List of ranked urls",final_url)
    ...
    print("Sorting by credibility")
    print ("Final similairty score ",final_score)
    print ("List of ranked urls",urls1)
